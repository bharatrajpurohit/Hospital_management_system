...
void menu()
{
    ...
    char choice;
    printf("\t\t*************************************************");
    printf("\n\t\t  *** WELCOME TO HOSPITAL AND BLOOD MANAGEMENT SYSTEM *** \n");
    printf("\n\t\t*************************************************");
    printf("\n\n\n\n\n");
    printf("\t\t\t\t*********************");
    printf("\n\t\t\t\t*--> 1.PATIENT      *");
        ...
        if(fp==NULL)
          {
             ...
             if(fp==NULL)
                    {
                        puts("\nSorry!! Cannot open file Please try again");
                        exit(1);
                    }
         }
    recsize=sizeof(p);
    ...
    /* DISPLAY OF OPTIONS */
          ...
          /* CHECKING FOR REGISTRATION NUMBER */
                                ...
                                if(iF==0||fread(&p,recsize,1,fp)==0)
                                {
                                   ...
                                   gets(p.doc_name);
                                   printf("\nEnter the history, if any, related to treatment of the patient(otherwise write N/A): ");
                                   gets(p.history);
...
void about()
{
                ...
                printf("This program is developed to maintain records of Patients,\n");

                printf("Employees and Inventory items in a hospital.\n");

                printf("Developed  By:\n");

                printf("**Mr.Bharat Singh\n");
